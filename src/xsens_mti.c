...
message_handler_ref_t inbound_handler_table[] = {
    ...
    { .id = MT_ACK_GOTOCONFIG, .handler_fn = NULL },
    { .id = MT_ACK_GOTOMEASUREMENT, .handler_fn = NULL },
    { .id = MT_ACK_RESET, .handler_fn = NULL },
    ...
    { .id = MT_ACK_SELFTEST, .handler_fn = &xsens_internal_handle_selftest_results },
    { .id = MT_ERROR, .handler_fn = &xsens_internal_handle_error },
    { .id = MT_WARNING, .handler_fn = NULL },
    { .id = MT_CONFIGURATION, .handler_fn = NULL },
    { .id = MT_MTDATA, .handler_fn = NULL },
    { .id = MT_MTDATA2, .handler_fn = &xsens_internal_handle_mdata2 },
    { .id = MT_ACK_LATLONALT, .handler_fn = NULL },
    { .id = MT_ACK_FILTERPROFILE, .handler_fn = NULL },
    { .id = MT_ACK_GNSSPLATFORM, .handler_fn = NULL },
    { .id = MT_ACK_GNSSLEVERARM, .handler_fn = NULL },
    { .id = MT_UTCTIME, .handler_fn = NULL },
    { .id = MT_ACK_ICCCOMMAND, .handler_fn = NULL },
    { .id = MT_ACK_INITIALHEADING, .handler_fn = NULL },
    { .id = MT_ACK_FORWARDGNSSDATA, .handler_fn = NULL },
    { .id = MT_ACK_BAUDRATE, .handler_fn = NULL },
    { .id = MT_ACK_TRANSMITDELAY, .handler_fn = NULL },
    { .id = MT_ACK_OPTIONFLAGS, .handler_fn = NULL },
    { .id = MT_ACK_LOCATIONID, .handler_fn = NULL },
    { .id = MT_ACK_SYNCSETTINGS, .handler_fn = NULL },
    { .id = MT_ACK_PERIOD, .handler_fn = NULL },
    { .id = MT_ACK_EXTOUTPUTMODE, .handler_fn = NULL },
    { .id = MT_ACK_OUTPUTCONFIGURATION, .handler_fn = NULL },
    { .id = MT_ACK_STRINGOUTPUTTYPES, .handler_fn = NULL },
    { .id = MT_ACK_RESETORIENTATION, .handler_fn = NULL },
    { .id = MT_ACK_AVAILABLEFILTERPROFILES, .handler_fn = NULL },
    { .id = MT_ACK_NOROTATION, .handler_fn = NULL },
};
