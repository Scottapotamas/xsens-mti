...
enum XSENS_OPTION_FLAGS
{
    XSENS_OPTFLAG_DISABLE_AUTOSTORE             = 0x01,
    XSENS_OPTFLAG_DISABLE_AUTOMEASUREMENT       = 0x02,
    XSENS_OPTFLAG_ENABLE_BEIDOU                 = 0x04,
    XSENS_OPTFLAG_RESERVED                      = 0x08,
    XSENS_OPTFLAG_ENABLE_AHS                    = 0x10,
    XSENS_OPTFLAG_ENABLE_ORIENTATION_SMOOTHER   = 0x20,
    XSENS_OPTFLAG_ENABLE_CONFIG_BUS_ID          = 0x40,
    XSENS_OPTFLAG_ENABLE_IN_RUN_COMPASS_CAL     = 0x80,
    XSENS_OPTFLAG_ENABLE_STARTUP_CONFIG_MSG     = 0x0200,
    XSENS_OPTFLAG_ENABLE_COLD_FILTER_RESET      = 0x0400,
    XSENS_OPTFLAG_ENABLE_POSITION_VEL_SMOOTHER  = 0x0800,
    XSENS_OPTFLAG_ENABLE_CONTINUOUS_ZRU         = 0x1000,
};

#define XSENS_OPTION_FLAG_IS_SET( OPTIONS, FLAG ) (((OPTIONS) & (FLAG)) == (FLAG))
#define XSENS_OPTION_FLAG_IS_ANY_SET(OPTIONS) ((OPTIONS) != 0)
#define XSENS_OPTION_FLAG_SET(OPTIONS, FLAG) ((OPTIONS) |= (FLAG))
